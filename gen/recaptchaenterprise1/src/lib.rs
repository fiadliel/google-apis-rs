...
//! 
//! * projects
//!  * [*assessments annotate*](api::ProjectAssessmentAnnotateCall), [*assessments create*](api::ProjectAssessmentCreateCall), [*keys create*](api::ProjectKeyCreateCall), [*keys delete*](api::ProjectKeyDeleteCall), [*keys get*](api::ProjectKeyGetCall), [*keys get metrics*](api::ProjectKeyGetMetricCall), [*keys list*](api::ProjectKeyListCall), [*keys migrate*](api::ProjectKeyMigrateCall), [*keys patch*](api::ProjectKeyPatchCall), [*relatedaccountgroupmemberships search*](api::ProjectRelatedaccountgroupmembershipSearchCall), [*relatedaccountgroups list*](api::ProjectRelatedaccountgroupListCall) and [*relatedaccountgroups memberships list*](api::ProjectRelatedaccountgroupMembershipListCall)
//! 
//! 
//! 
//! 
