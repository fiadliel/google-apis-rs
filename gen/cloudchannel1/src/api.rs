...
///              .page_size(-13)
///              .language_code("et")
///              .create_entitlement_purchase_sku("sed")
///              .change_offer_purchase_new_sku("et")
///              .change_offer_purchase_entitlement("et")
///              .doit().await;
/// # }
/// ```
...
///              .page_size(-93)
///              .language_code("duo")
///              .create_entitlement_purchase_product("dolore")
///              .change_offer_purchase_entitlement("et")
///              .change_offer_purchase_change_type("voluptua.")
///              .doit().await;
/// # }
/// ```
