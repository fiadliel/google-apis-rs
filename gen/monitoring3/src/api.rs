...
///              .view("ipsum")
///              .secondary_aggregation_per_series_aligner("et")
///              .add_secondary_aggregation_group_by_fields("sanctus")
///              .secondary_aggregation_cross_series_reducer("Lorem")
///              .secondary_aggregation_alignment_period(chrono::Duration::seconds(9368059))
///              .page_token("diam")
///              .page_size(-19)
///              .order_by("dolores")
///              .interval_start_time(chrono::Utc::now())
...
///              .aggregation_cross_series_reducer("et")
///              .aggregation_alignment_period(chrono::Duration::seconds(988174))
///              .doit().await;
/// # }
/// ```
...
///              .service_level_objective_id("aliquyam")
///              .doit().await;
/// # }
/// ```
